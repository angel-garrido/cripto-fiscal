...
archivo_salida = "resumen_fiscal_crypto_ESPANA_CORREGIDO.xlsx"
...
# Para recompensas y minería: usar valor de mercado (correcto según AEAT)
...
# ====================== VENTAS - CORRECCIÓN IMPORTANTE ======================
ventas = df[df['tipo'] == 'venta'].copy()

# Solo incluimos ventas de criptomonedas (excluimos ventas de EUR)
...
print("Monedas vendidas:", sorted(ventas_ganancia['moneda'].unique()))
