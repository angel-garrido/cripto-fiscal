...
archivo_salida = "resumen_fiscal_crypto_ESPANA.xlsx"   # ← Nombre exacto que pediste
...
print("\n=== RESUMEN FINAL 2025 ===")
print(resumen_anual[resumen_anual.get('Año') == 2025] if 'Año' in resumen_anual.columns else 
      resumen_anual[resumen_anual.get('año') == 2025])
...
with pd.ExcelWriter(archivo_salida, engine='openpyxl') as writer:
    ...
    instrucciones = pd.DataFrame({
        ...
        'Notas': ["Método FIFO", "Valor de mercado", "Valor de mercado"]
